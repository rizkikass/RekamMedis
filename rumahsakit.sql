...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2020 at 03:25 PM
...
(2, 'Kikaa', '2000-01-01', 'P', 'Islam', 'WNI', 'Bandung', 'Pelajar', '0812344');
...
(3, 2, 1, 2, '2020-07-18', 'Tunai', 'Datang Sendiri', 'Dokter Umum', '-'),
(4, 2, 1, 21, '2020-07-18', 'Tunai', 'Datang Sendiri', 'Penyakit Dalam', '-');
...
CREATE TABLE `rekam_medis` (
  ...
  `terapi` varchar(30) NOT NULL,
  `cara_keluar` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(2, 3, '2020-07-18', '2020-07-18', '200', 'Dokter Umum', 'anaamnesaa', 'diagnosa2', '-', '-');
